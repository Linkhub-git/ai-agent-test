...
def fake_ask_agent(mensaje_usuario):
    pasos = [
        ...
        {
            "reasoning": "2025-04-22T09:02:12Z | linkhub-eval-Agent  | 🔍  Evaluando métricas de control del proceso Validator",
            "sleep": 1
        },
        {
            "reasoning": "2025-04-22T09:02:12Z | linkhub-eval-Agent  | 🆗  Métricas correctas 97%",
            "sleep": 1
        },
        {
        ...
        {
            "reasoning": "2025-04-22T09:02:12Z | linkhub-eval-Agent  | 🆗  Métricas correctas 99%",
            "sleep": 1
        },
        {
        ...
        {
            "reasoning": "2025-04-22T09:02:12Z | linkhub-eval-Agent  | 🆗  Métricas correctas 94%",
            "sleep": 1
        },
        {
        ...
        {
            "reasoning": "2025-04-22T09:02:12Z | linkhub-eval-Agent  | 🔍  Evaluando métricas de control del proceso Pre-Approval",
            "sleep": 1
        },
        {
            "reasoning": "2025-04-22T09:02:12Z | linkhub-eval-Agent  | 🆗  Métricas correctas 98%",
        ...
        {
            "reasoning": "2025-04-22T09:05:40Z | Approval-Hub        | 📲  Notificación WhatsApp enviada al Jefe-Riesgos (timeout = 15 min)",
            "sleep": 1
        },
        {
        ...
        {
            "reasoning": "2025-04-22T09:02:12Z | linkhub-eval-Agent  | 🔍  Evaluando métricas de control del proceso Approval-Hub",
            "sleep": 1
        },
        {
            "reasoning": "2025-04-22T09:02:12Z | linkhub-eval-Agent  | 🆗  Métricas correctas 100%",
        ...
        {
            "reasoning": "2025-04-22T09:02:12Z | linkhub-eval-Agent  | 🔍  Evaluando métricas de control del proceso Generador-Valores",
            "sleep": 1
        },
        {
            "reasoning": "2025-04-22T09:02:12Z | linkhub-eval-Agent  | 🆗  Métricas correctas 100%",
        ...
        {
            "reasoning": "2025-04-22T09:02:12Z | linkhub-eval-Agent  | 🔍  Evaluando métricas de control del proceso Release-Delivery",
            "sleep": 1
        },
        {
            "reasoning": "2025-04-22T09:02:12Z | linkhub-eval-Agent  | 🆗  Métricas correctas 97%",
    ...
    fin = "¿El caso requiere Garantía mobilaria?"
    razonamiento = "2025-04-22T09:02:34Z | Validator-Agent     | 👤 Preguntamos al usuario"
    
    if mensaje_usuario == "Iniciar":
        print("Inicio")
        pasos = pasos[:22]
    elif mensaje_usuario == "iniciar":
        print("Inicio")
        pasos = pasos[:22]
    else:
        print("Fin")
        pasos = pasos[-52:]
        fin = "Flujo cerrado - SLA TOTAL: 22 m 44 s, tokens LLM: 17 392"
        razonamiento = "2025-04-22T09:24:55Z | Auditor-360         | 🗄️  Flujo cerrado - SLA TOTAL: 22 m 44 s, tokens LLM: 17 392"
